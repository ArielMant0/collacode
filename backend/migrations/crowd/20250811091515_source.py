...
Migration Name: source
Migration Version: 20250811091515
"""
...
def upgrade(connection):
    ...
    # insert clients
    cur.executemany(
        "INSERT INTO client_info (guid, ip, cwId, source, method, requests_recent, recent_update, last_update) " +
        "VALUES (:guid, :ip, :cwId, :source, :method, :requests_recent, :recent_update, :last_update);",
        clients,
    )
